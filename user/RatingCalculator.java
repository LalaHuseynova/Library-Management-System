...
public class RatingCalculator {
    ...
    private static final String PERSONS_FOLDER_PATH = "persons"; // Path to the folder containing CSV files
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(file))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (fields.length >= 10) { 
                    ...
                    try {
                        int rating = Integer.parseInt(fields[8]); // Assuming the rating is an integer
    ...
    public static void main(String[] args) {
        ...
        File originalFile = new File("files/copy.csv");
        File newFile = new File("files/personal.csv");
